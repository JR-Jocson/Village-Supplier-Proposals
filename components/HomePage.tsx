...
const translations = {
  he: {
    ...
    subtitle: 'פלטפורמה פשוטה ויעילה להעלאת ואימות הצעות פרויקטים לקיבוצים',
    cta: 'התחל עכשיו',
    tagline: 'מחבר בין קיבוצים לרשויות מקומיות',
    footer: '© 2025 הצעות פרויקטים לקיבוצים. כל הזכויות שמורות.',
  },
  en: {
    title: {
